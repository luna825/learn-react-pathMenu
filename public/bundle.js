...
/***/ function(module, exports, __webpack_require__) {
	...
	var SPRING_CONFIG = { stiffness: 400, damping: 18 };
	var SPRING_CONFIG1 = { stiffness: 500, damping: 30 };
	...
	var APP = function (_React$Component) {
	    ...
	    _createClass(APP, [{
	        ...
	        value: function finalChildButtonStyles(childIndex) {
	            var _finalDeltaPositions = finalDeltaPositions(childIndex);

	            var deltaY = _finalDeltaPositions.deltaY;
	            var deltaX = _finalDeltaPositions.deltaX;
	        ...
	        value: function renderChildButtons() {
	            ...
	            var calculateStylesForNextFrame = function calculateStylesForNextFrame(prevFrameStyles) {
	                var springStyle = function springStyle(style) {
	                    return Object.keys(style).reduce(function (result, key) {
	                        result[key] = (0, _reactMotion.spring)(style[key], SPRING_CONFIG);
	                        return result;
	                    }, {});
	                };
	                var scaleMin = _this2.initialChildButtonStyles().scale;
	                var scaleMax = _this2.finalChildButtonStyles(0).scale;
	            ...
	            return _react2.default.createElement(
	                ...
	                function (interpolatedStyles) {
	                    return _react2.default.createElement(
	                        'div',
	                        null,
	                        interpolatedStyles.map(function (_ref, i) {
	                            var top = _ref.top;
	                            var left = _ref.left;
	                            ...
	                            return _react2.default.createElement(
	                                ...
	                                _react2.default.createElement('i', { className: "fa fa-" + childButtonIcons[i] + " fa-lg" })
	                            );
	                        })
	                    );
	                }
	        ...
	        value: function render() {
	            ...
	            var mainButtonRotation = isOpen ? { rotate: (0, _reactMotion.spring)(0, SPRING_CONFIG1) } : { rotate: (0, _reactMotion.spring)(-135, SPRING_CONFIG1) };
	            return _react2.default.createElement(
	                'div',
	                null,
	                ...
	                _react2.default.createElement(
	                    ...
	                    function (_ref2) {
	                        ...
	                        return _react2.default.createElement(
	                            'div',
	                            { style: _extends({}, _this3.mainButtonStyles(), { transform: 'rotate(' + rotate + 'deg)' }), className: 'main-button', onClick: function onClick(e) {
	                                    return _this3.openMenu(e);
	                                } },
